import { BookOpen, MessageCircle, ShoppingBag } from "lucide-react";
...
export default function HeroMotion() {
  ...
  return (
    <section className="relative flex min-h-[100dvh] flex-col bg-[#0a0a0a]">
      {/* top bar */}
      <div className="mx-auto flex w-full max-w-[1200px] items-center justify-between px-6 py-5">
        ...
        <div className="flex items-center gap-2">
          <LangToggle />
          <a
            href="https://github.com/phumitchreal"
            target="_blank"
            rel="noopener"
            className="inline-flex h-7 items-center gap-1.5 rounded-md bg-[#1a1a1a] px-3 text-xs font-medium text-white/80 hover:bg-[#242424] hover:text-white transition-colors"
          >
            <span className="h-3 w-3 rounded-[2px] bg-white/20 flex items-center justify-center text-[8px]">↗</span>
            GitHub
          </a>
        </div>
      </div>
